...
const About = () => {
  return (
    <section
      id="about"
      className="flex flex-col justify-center items-center bg-[#171d32] text-white px-6 py-16"
    >
      {/* 🔹 Heading Section */}
        ...
        <ul className="space-y-8">
          <li className="flex gap-4">
            ...
            <span className="max-w-md">
              ...
              <p className="text-sm md:text-base text-gray-300">
                Expert in building interactive, fast, and responsive UIs using
          ...
          <li className="flex gap-4">
            ...
            <span className="max-w-md">
              ...
              <p className="text-sm md:text-base text-gray-300">
                Experienced in creating RESTful APIs with Node.js and Express,
          ...
          <li className="flex gap-4">
            ...
            <span className="max-w-md">
              ...
              <p className="text-sm md:text-base text-gray-300">
                Skilled in MongoDB, schema design, and optimizing database
